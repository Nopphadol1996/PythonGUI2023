...
# IMAGE
icon = 'D:\\leaning\\Python GUI2023\\expense.png'
iconimage = PhotoImage(file=icon)
L = Label(T1,image=iconimage)
L.pack()

# ช่องรายการค่าใช้จ่าย
L = Label(T1,text='รายการค่าใช้จ่าย', font=(None,30),fg='green')
L.pack(pady=5)
...
def Fav1(event=None):
	...
	v_amount.set('15')
style = ttk.Style()
a = style.configure("TButton", background="red")
...
B1 = ttk.Button(T1,text='บันทึก',style=a,command=SaveData)
